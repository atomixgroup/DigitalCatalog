...
public class ProductListAdapter extends RecyclerView.Adapter<ProductListAdapter.ProductListViewHolder> {
    ...
    public ProductListAdapter(ArrayList<Product> products, DeleteItemListener deleteItemListener){
    ...
    public ProductListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ProductListViewHolder(LayoutInflater.from(App.context).inflate(R.layout.category_adapter,parent,false));
    }
    ...
    public class ProductListViewHolder extends RecyclerView.ViewHolder{
        ...
        private CustomTextView item_title,item_description,seenCount;
